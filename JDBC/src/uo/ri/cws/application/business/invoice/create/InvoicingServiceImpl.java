...
import uo.ri.cws.application.business.invoice.create.commands.FindNotInvoicedWorksOrders;
...
public class InvoicingServiceImpl implements InvoicingService{
	...
	public InvoiceDto createInvoiceFor(List<String> workOrderIds) throws BusinessException {
		...
		return exectutor.execute( new CreateInvoice(workOrderIds));
	}
	...
	public List<InvoicingWorkOrderDto> findNotInvoicedWorkOrdersByClientDni(String dni) throws BusinessException {
		...
		return exectutor.execute(new FindNotInvoicedWorksOrders(dni));
	}
